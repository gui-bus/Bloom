            ...
            preview={
              <div className="flex w-full flex-col gap-4">
                ...
                <Banner
                  variant="success"
                  icon={
                    <Icon icon="hugeicons:tick-circle" className="h-5 w-5" />
                  }
                >
                ...
                <Banner
                  variant="danger"
                  icon={
                    <Icon icon="hugeicons:alert-circle" className="h-5 w-5" />
                  }
                >
              ...
              <div className="w-full">
                {isVisible ? (
                  <Banner
                    ...
                    icon={
                      <Icon icon="hugeicons:sparkles" className="h-5 w-5" />
                    }
                  >
          ...
          <DocsComponent
            ...
            preview={
              <Banner
                variant="warning"
                icon={
                  <Icon icon="hugeicons:wifi-error-01" className="h-5 w-5" />
                }
                action={
                ...
                announcements={[
                  {
                    id: 1,
                    content:
                      "🚀 Version 3.0 launched! Check out the changelog.",
                    icon: <Icon icon="hugeicons:rocket" className="h-5 w-5" />,
                  },
                  {
                    id: 2,
                    content:
                      "🎉 We reached 10,000 active developers on Bloom UI!",
                    icon: (
                  ...
                  },
                  {
                    ...
                    icon: (
                      <Icon icon="hugeicons:video-01" className="h-5 w-5" />
                    ),
                  },
                ]}
              />
