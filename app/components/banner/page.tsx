  ...
  return (
    <div className="space-y-8">
      ...
      <CodeBlock
        ...
        description="Banner component supporting variants, announcements carousel, sticky positioning, and local storage persistence."
      ...
      <DocsComponent
        ...
        preview={
          <Banner
            icon={
              <Icon icon="hugeicons:information-circle" className="h-5 w-5" />
            }
          >
        ...
        preview={
          <div className="flex w-full flex-col gap-4">
            <Banner
              variant="default"
              icon={
                <Icon icon="hugeicons:notification-01" className="h-5 w-5" />
              }
            >
            ...
            <Banner
              variant="success"
              icon={<Icon icon="hugeicons:tick-circle" className="h-5 w-5" />}
            >
            ...
            <Banner
              variant="warning"
              icon={<Icon icon="hugeicons:alert-02" className="h-5 w-5" />}
            >
            ...
            <Banner
              variant="danger"
              icon={<Icon icon="hugeicons:alert-circle" className="h-5 w-5" />}
            >
            ...
            announcements={[
              {
                ...
                icon: <Icon icon="hugeicons:rocket" className="h-5 w-5" />,
              },
              {
                id: 2,
                content: "🎉 We reached 10,000 active developers on Bloom UI!",
                icon: (
                  <Icon icon="hugeicons:party-popper" className="h-5 w-5" />
                ),
              },
              {
                id: 3,
                ...
                icon: <Icon icon="hugeicons:video-01" className="h-5 w-5" />,
              },
            ]}
          />
        }
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            <tr className="border-b border-zinc-200 dark:border-zinc-800">
              ...
              <td className="px-4 py-3 font-mono text-xs text-zinc-500">-</td>
              <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                Optional action component (e.g., button) placed before the
                dismiss button.
              </td>
            </tr>
            <tr className="border-b border-zinc-200 dark:border-zinc-800">
              ...
              <td className="px-4 py-3 font-mono text-xs text-zinc-500">-</td>
              <td className="px-4 py-3 text-zinc-600 dark:text-zinc-400">
                Optional icon displayed at the start of the banner.
              </td>
            </tr>
          </tbody>
        </table>
