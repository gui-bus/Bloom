...
export default function ColorPickerComponentPage() {
  return (
    <div className="space-y-8">
      ...
      <ImportSnippet
        importCode={`import { ColorPicker } from "@/components/ui/colorPicker/colorPicker";`}
      />
      ...
      <DocsComponent
        ...
        preview={
          <div className="w-full flex flex-col gap-6">
            <div>
              <span className="text-xs font-mono text-zinc-500 dark:text-zinc-400 block mb-2">
                defaultFormat="hex"
              </span>
              ...
              <tbody>
                <tr className="border-b border-border">
                  ...
                  <td className="px-3 py-2 text-muted-foreground">
                    Controlled HEX color value string.
                  </td>
                </tr>
                <tr className="border-b border-border">
                ...
                <tr className="border-b border-border">
                  ...
                  <td className="px-3 py-2 text-muted-foreground">
                    Renders the interactive canvas-based color wheel.
                  </td>
                </tr>
                <tr className="border-b border-border">
                  <td className="px-3 py-2 font-mono text-primary">
                  ...
                  <td className="px-3 py-2 text-muted-foreground">
                    Shows the HEX/RGB/HSL format toggle button.
                  </td>
                </tr>
                <tr className="border-b border-border">
                  <td className="px-3 py-2 font-mono text-primary">
                  ...
                  <td className="px-3 py-2 text-muted-foreground">
                    Starting color format for the text display.
                  </td>
                </tr>
                <tr className="border-b border-border">
                  ...
                  <td className="px-3 py-2 text-muted-foreground">—</td>
                  <td className="px-3 py-2 text-muted-foreground">
                    Label text rendered above the color picker.
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="px-3 py-2 text-muted-foreground">false</td>
                  <td className="px-3 py-2 text-muted-foreground">
                    Disables all user interaction with the picker.
                  </td>
                </tr>
              </tbody>
            </table>
