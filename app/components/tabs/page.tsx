...
export default function TabsComponentPage() {
  return (
    <main className="max-w-400 mx-auto p-5 space-y-6">
      <section className="space-y-8">
        <div>
          <h2 className="text-2xl font-bold">Tabs</h2>
          <p className="font-light">
            Navegação por abas utilizada para organizar conteúdos relacionados e
            facilitar a alternância entre seções sem perda de contexto.
          </p>
        </div>
