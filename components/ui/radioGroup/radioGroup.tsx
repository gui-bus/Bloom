...
const RadioGroup = React.forwardRef<
  ...
  RadioGroupProps
>(({ className, color = "primary", orientation = "vertical", columns, label, description, isInvalid = false, children, ...props }, ref) => {
  return (
...
const RadioGroupItem = React.forwardRef<
  ...
  RadioGroupItemProps
>(({ className, label, description, isCard = false, icon, badge, price, id, disabled, ...props }, ref) => {
