        ...
        {change !== undefined && (
          <div
            className={cn(
              ...
              trend === "down" && "bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20",
              trend === "neutral" && "bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700"
            )}
          >
            {trend === "up" && <Icon icon="hugeicons:trade-up-02" className="size-3.5" />}
            {trend === "down" && <Icon icon="hugeicons:trade-down-02" className="size-3.5" />}
            <span>{change}</span>
          </div>
        )}
      </div>
